...
class GetOSSInfoForUploadFileResponseBody extends Model
{
    ...
    /**
     * @description The ID of this call request, which is a unique identifier generated by Alibaba Cloud for the request, can be used for troubleshooting and issue定位.
     *
    ...
    /**
     * @description Indicates success. Values:
     *
     * - **true**
     * - **false**
     * @example true
